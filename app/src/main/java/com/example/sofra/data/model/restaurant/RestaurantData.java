...
public class RestaurantData {
    ...
    @Expose
    private GeneralData region;
    @SerializedName("categories")
    @Expose
    private List<GeneralData> categories = null;
    ...
    public GeneralData getRegion() {
        return region;
    }

    public void setRegion(GeneralData region) {
        this.region = region;
    }

    public List<GeneralData> getCategories() {
        return categories;
    }

    public void setCategories(List<GeneralData> categories) {
