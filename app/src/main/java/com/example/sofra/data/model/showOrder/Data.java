...
package com.example.sofra.data.model.showOrder;
...
public class Data {
    ...
    @Expose
    private List<ItemFoodData> items = null;
    @SerializedName("client")
    @Expose
    private GeneralData client;
    ...
    public List<ItemFoodData> getItems() {
        return items;
    }

    public void setItems(List<ItemFoodData> items) {
        this.items = items;
    }

    public GeneralData getClient() {
        return client;
    }

    public void setClient(GeneralData client) {
        this.client = client;
    }
