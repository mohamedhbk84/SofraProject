...
public class EmotionRating extends  android.support.v7.widget.AppCompatRatingBar {
    ...
    public EmotionRating(Context context) {
        super(context);
        init();
    }

    public EmotionRating(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public EmotionRating(Context context, AttributeSet attrs, int defStyleAttr) {
