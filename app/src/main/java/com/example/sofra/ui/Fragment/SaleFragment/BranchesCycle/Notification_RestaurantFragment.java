 ...
 */
public class Notification_RestaurantFragment extends Fragment {
    ...
    public Notification_RestaurantFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_notification__restaurant, container, false);
...
apiServices.RestaurantNotifications("Jptu3JVmDXGpJEaQO9ZrjRg5RuAVCo45OC2AcOKqbVZPmu0ZJPN3T1sm0cWx").enqueue(new Callback<Notifications>() {
    @Override
