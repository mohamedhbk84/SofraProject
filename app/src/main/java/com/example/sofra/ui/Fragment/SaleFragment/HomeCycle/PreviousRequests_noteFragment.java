 ...
 */
public class PreviousRequests_noteFragment extends Fragment {


    @BindView(R.id.previous_RV)
    RecyclerView previousRV;
    Unbinder unbinder;
    ...
    public PreviousRequests_noteFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_previous_requests_note, container, false);
    ...
    private void getllComplete() {
        apiServices.getAllOrders("Jptu3JVmDXGpJEaQO9ZrjRg5RuAVCo45OC2AcOKqbVZPmu0ZJPN3T1sm0cWx","completed",page).enqueue(new Callback<RestaurantMyOrders>() {
            @Override
